...
address: "Shapiro Library Room 4059, 919 S University Avenue, Ann Arbor, Michigan 48109"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "42.275000"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-83.738170"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Oct 20-21, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2022-10-20      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-10-21        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Nick Lesniak", "Corwin Kerr", "Kelly Sovacool", "Sarah Lucas", "Pat Schloss"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Grace Kenney", "Pariksheet Nanda", "Rohit Singla", "Fred Fang"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["salucas@umich.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2022-10-20-UMich # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
3. After you have installed everything above, download [un-report.zip](https://github.com/UMSWC/curriculum/raw/gh-pages/files/un-report.zip). You'll need the files included during the workshop.
    ...
    4. Take a screenshot of (or copy & paste) the console output and send it via email to the lead instructor (<a href='mailto:salucas@umich.edu'>salucas@umich.edu</a>). Be sure to include the line starting with `source("` to the end.
</div>
